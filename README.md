...
* **HTML / CSS:** Верстка с использованием Grid/Flexbox, анимация через `@keyframes`, фильтры для имитации ЭЛТ-мониторов.
* **JavaScript:** Использование модульной архитектуры (`import/export`) для оптимизации производительности.
